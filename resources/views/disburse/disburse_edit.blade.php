...
<div class="container card-plane pb-3">
    ...
    <div class="row asset-stats my-3">
        <div class="col">
            <form action="disburse/update/{{$disburseData['id']}}" method="post" enctype="multipart/form-data">
                @csrf
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        <td>ไฟล์เบิก ผรม <span class="text-red">*</span>
                            <br>
                            @if($disburseData['file_vendor'] != '')
                            <a href="{{asset($disburseData['file_vendor'])}}" target="_blank" class="btn btn-blue">ดูไฟล์</a>
                            @else
                            <a href="#" class="btn btn-blue disabled">ไม่มีไฟล์</a>
                            @endif
                        </td>
                        <td>
                            <input type="hidden" name="oldPathVendor" value="{{$disburseData['file_vendor']}}">
                            <input type="file" name="fileVendor" class="form-control" id="">
                            <span class="text-red">* ขนาดไฟล์ต้องไม่เกิน 1 MB</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="hidden" name="oldPathSws" value="{{$disburseData['file_sws']}}">
