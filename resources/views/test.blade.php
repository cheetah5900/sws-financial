...
<body id="kt_body" class="dark-mode header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
	<!--begin::Main-->
	<!--begin::Root-->
					...
					<div class="mb-0">
						...
						<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
							<div class="d-flex flex-stack">
								...
								<div class="text-nowrap">
									<a href="https://keenthemes.com/contact/" class="btn btn-sm btn-green" target="_blank">Contact Us</a>
								</div>
							</div>
						</div>
						<!--end::License-->
							...
							<div class="row g-5">
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo1" class="btn btn-sm btn-green shadow">Demo 1</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo2" class="btn btn-sm btn-green shadow">Demo 2</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo3" class="btn btn-sm btn-green shadow">Demo 3</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo4" class="btn btn-sm btn-green shadow">Demo 4</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo5" class="btn btn-sm btn-green shadow">Demo 5</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo6" class="btn btn-sm btn-green shadow">Demo 6</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo7" class="btn btn-sm btn-green shadow">Demo 7</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo8" class="btn btn-sm btn-green shadow">Demo 8</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo9" class="btn btn-sm btn-green shadow">Demo 9</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo10" class="btn btn-sm btn-green shadow">Demo 10</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo11" class="btn btn-sm btn-green shadow">Demo 11</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo12" class="btn btn-sm btn-green shadow">Demo 12</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo13" class="btn btn-sm btn-green shadow">Demo 13</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo14" class="btn btn-sm btn-green shadow">Demo 14</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										...
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo15" class="btn btn-sm btn-green shadow">Demo 15</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
		...
		<div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
			...
			<div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
				...
				<div class="d-flex flex-stack">
					...
					<!--end::Actions-->
					<!--begin::Send-->
					<button class="btn btn-blue"pe="button" data-kt-element="send">Send</button>
					<!--end::Send-->
				</div>
				<!--end::Toolbar-->
			</div>
		...
		<div class="modal-dialog mw-1000px">
			...
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-end">
					...
					<button type="button" id="kt_modal_select_location_button" class="btn btn-blue"ta-bs-dismiss="modal">Apply</button>
				</div>
				<!--end::Modal footer-->
			</div>
			<!--end::Modal content-->
			...
			<div class="modal-content rounded">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
					...
					<div class="d-flex flex-center flex-row-fluid pt-12">
						...
						<button type="submit" class="btn btn-blue"grade Plan</button>
					</div>
					<!--end::Actions-->
				</div>
				<!--end::Modal body-->
