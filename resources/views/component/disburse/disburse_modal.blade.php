                    ...
                    <div class="col">
                        <form action="disburse/add" method="post" enctype="multipart/form-data">
                            ...
                            <table class="white-text">
                                <tr>
                                    <td width="40%">ชื่อเบิกจ่าย <span class="text-danger">*</span></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="receivedDate" class="form-control" id="" placeholder="ตัวอย่าง 31/01/2021,28/02/2022"></td>
                                </tr>
                                <tr>
