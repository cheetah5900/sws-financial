            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{asset($advanceData['file_account'])}}" target="_blank" class="btn btn-info">ดูไฟล์</a>
                        @else
                        ไม่มีไฟล์สมุดบัญชี
                        @endif
                    </td>
                ...
                <tr>
                    <th>ไฟล์ Advance</th>
                    <td>
                        <a href="{{asset($advanceData['file_advance'])}}" target="_blank" class="btn btn-info">ดูไฟล์</a>
                    </td>
                </tr>
            </table>
        </div>
