...
for ($u = 1; $u <= 3; $u++) { // วนลูปเพื่อให้ทำงาน 2 รอบ แต่ละรอบจะเปลี่ยนเงื่อนไขที่เอาเข้าไป loop 
    ...
    $endPoint = "http://new.finan.srisomwong.com/public/";
    ...
    if ($countAllArrData == 0) { // ถ้านับจำนวนแล้วข้อมูลที่ส่งเข้ามาว่ามีค่ามั้ย ถ้าไม่มีก็จะให้ส่งข้อความไปได้เลย แต่ถ้ามีก็ต้องไป fetch ข้อมูลออกมา
        ...
        foreach ($data as $row) {
            ...
            echo $receivedDate = $row['received_date'];
            echo "<br>";
            ...
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][2]["spacing"] = "sm";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][2]["contents"][0]["type"] = "text";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][2]["contents"][0]["text"] = "รับเงิน";
            ...
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][2]["contents"][1]["text"] = $receivedDate;
            ...
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["type"] = "box";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["layout"] = "baseline";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["type"] = "text";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["text"] = "คงเหลือ";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["weight"] = "bold";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["size"] = "sm";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["color"] = "#AAAAAA";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][0]["flex"] = 1;
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["type"] = "text";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["text"] = number_format($row['remain_value'], 2) . " บาท";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["size"] = "sm";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["color"] = "#666666";
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["flex"] = 4;
            $datas["contents"]["contents"][$i]["body"]["contents"][1]["contents"][3]["contents"][1]["wrap"] = true;
